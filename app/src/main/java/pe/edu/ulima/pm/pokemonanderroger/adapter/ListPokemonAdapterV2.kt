...
class ListPokemonAdapterV2 (
    private val ListPokemones: List<Pokemon>,
    private val fragment: Fragment,
    private val listener: (Pokemon) -> Unit

) : RecyclerView.Adapter<ListPokemonAdapterV2.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {//ATRIBUTOS
        ...
        holder.tvispecialDefense.text =
            "Special Defense: ${ListPokemones[position].special_defense}"
